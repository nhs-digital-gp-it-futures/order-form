...
describe('solution select routes', () => {
  describe('GET /organisation/:orderId/solution/select', () => {
    const path = '/organisation/order-1/solution/select';
    ...
    it('should redirect to the solution/select/solution', () => {
      ...
      return request(setUpFakeApp())
        ...
        .then((res) => {
          ...
          expect(res.headers.location).toEqual(`${baseUrl}/organisation/order-1/solution/select/solution`);
        });
    });
  });

  describe('GET /organisation/:orderId/solution/select/solution', () => {
    const path = '/organisation/some-order-id/solution/select/solution';
    ...
    it('should return the solution select-solution page if authorised', () => {
      selectSolutionController.getSolutionsPageContext = jest.fn()
        .mockResolvedValue({});
  ...
  describe('POST /organisation/:orderId/solution/select/solution', () => {
    const path = '/organisation/order-1/solution/select/solution';
    ...
    it('should redirect to /organisation/some-order-id/solution/select/solution/price if a solution is selected', async () => {
      selectSolutionController.validateSolutionForm = jest.fn()
      ...
      return request(setUpFakeApp())
        ...
        .then((res) => {
          expect(res.redirect).toEqual(true);
          expect(res.headers.location).toEqual(`${baseUrl}/organisation/order-1/solution/select/solution/price`);
        });
    });
  });

  describe('GET /organisation/:orderId/solution/select/solution/price', () => {
    const path = '/organisation/some-order-id/solution/select/solution/price';
    ...
    it('should return the solution select price page if authorised', () => {
  ...
  describe('POST /organisation/:orderId/solution/select/solution/price', () => {
    const path = '/organisation/order-1/solution/select/solution/price';
    ...
    it('should redirect to /organisation/some-order-id/solution/select/solution/price if a solution is selected', async () => {
      ...
      return request(setUpFakeApp())
        ...
        .then((res) => {
          expect(res.redirect).toEqual(true);
          expect(res.headers.location).toEqual(`${baseUrl}/organisation/order-1/solution/select/solution/price/recipient`);
        });
    });
  });

  describe('GET /organisation/:orderId/solution/select/solution/price/recipient', () => {
    const path = '/organisation/some-order-id/solution/select/solution/price/recipient';
    ...
    it('should return the solution select recipient page if authorised', () => {
  ...
  describe('POST /organisation/:orderId/solution/select/solution/price/recipient', () => {
    const path = '/organisation/order-1/solution/select/solution/price/recipient';
    ...
    it('should redirect to /organisation/some-order-id/solution/neworderitem if a recipient is selected', async () => {
      selectRecipientController.getSolution = jest.fn()
        .mockResolvedValue({ name: 'Solution One ' });
      ...
      return request(setUpFakeApp())
        ...
        .then((res) => {
          expect(res.redirect).toEqual(true);
          expect(res.headers.location).toEqual(`${baseUrl}/organisation/order-1/solution/neworderitem`);
        });
    });
  });
});
