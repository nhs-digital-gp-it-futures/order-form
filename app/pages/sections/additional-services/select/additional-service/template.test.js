...
const setup = {
  template: {
    path: 'pages/sections/additional-services/select/additional-service/template.njk',
  },
};
...
describe('additional-services select page', () => {
  it('should render a backLink', componentTester(setup, (harness) => {
    const context = {
      ...
      backLinkHref: '/organisation/order-1/additional-services',
    };
    ...
    harness.request(context, ($) => {
      ...
      expect($(backLink).find('a').attr('href')).toEqual('/organisation/order-1/additional-services');
    });
  }));
  ...
  it('should render the additional-services-select page title', componentTester(setup, (harness) => {
    ...
    harness.request(context, ($) => {
      const title = $('h1[data-test-id="additional-services-select-page-title"]');
  ...
  it('should render the additional-services-select page description', componentTester(setup, (harness) => {
    ...
    harness.request(context, ($) => {
      const description = $('h2[data-test-id="additional-services-select-page-description"]');
