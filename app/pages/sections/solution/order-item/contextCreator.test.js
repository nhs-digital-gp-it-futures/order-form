...
describe('solution order-item contextCreator', () => {
  describe('getContext', () => {
    ...
    it('should return the backLinkHref to catalogue solutions when order item id is not neworderitem', () => {
      ...
      expect(context.backLinkHref).toEqual('/order/organisation/undefined/solution');
    });
    ...
    it('should return the backLinkHref to recipient when order item id is neworderitem', () => {
      ...
      expect(context.backLinkHref).toEqual('/order/organisation/undefined/solution/select/solution/price/recipient');
    });
