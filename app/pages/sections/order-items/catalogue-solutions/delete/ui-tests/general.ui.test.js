...
fixture('delete-catalogue page - general')
...
test('should render delete-catalogue select page', async (t) => {
  await pageSetup();
  await t.navigateTo(pageUrl);
...
test('should render the title', async (t) => {
  ...
  await t
    .expect(await extractInnerText(title)).eql('Delete write-on-time from order-id?');
});
...
test('should render the description', async (t) => {
  ...
  const description = Selector('h2[data-test-id="delete-catalogue-page-description"]');
...
test('should render the order description title', async (t) => {
  ...
  const orderDescriptionTitle = Selector('h3[data-test-id="catalogue-description-title"]');
...
test('should render the order description', async (t) => {
  ...
  const orderDescription = Selector('h4[data-test-id="catalogue-description"]');
