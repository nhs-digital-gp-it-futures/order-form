...
const pageUrl = 'http://localhost:1234/order/organisation/odsCode/order/order-id/additional-services/delete/order-item-id/confirmation/write-on-time-additional-service/';
...
test('should link to /order/organisation/odsCode/order/order-id/additional-services for backLink', async (t) => {
  await pageSetup();
  await t.navigateTo(pageUrl);
  ...
  await t
    ...
    .expect(goBackLink.getAttribute('href')).eql('/order/organisation/odsCode/order/order-id/additional-services/order-item-id');
});
...
test('should render the go back link', async (t) => {
  ...
  await t
    ...
    .expect(link.getAttribute('href')).eql('/order/organisation/odsCode/order/order-id/additional-services/order-item-id');
});
...
test('should redirect to /organisation/odsCode/order/order-id/additional-services/delete/order-item-id/confirmation/write-on-time-additional-service/continue when Confirm is clicked', async (t) => {
  ...
  await t
    .click(button)
    .expect(getLocation()).eql('http://localhost:1234/order/organisation/odsCode/order/order-id/additional-services/delete/order-item-id/confirmation/write-on-time-additional-service/continue');
});
