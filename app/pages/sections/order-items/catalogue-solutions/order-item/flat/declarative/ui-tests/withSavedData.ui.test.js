...
test('should navigate to catalogue solution dashboard page if save button is clicked and data is valid', async (t) => {
  nock(orderApiUrl)
    .put('/api/v1/orders/order-1/order-items/existing-order-id', { deliveryDate: '2020-04-27', quantity: 310, price: 0.11 })
    .reply(200, {});
...
test('should show text fields as errors with error message when there are BE validation errors', async (t) => {
  nock(orderApiUrl)
    .put('/api/v1/orders/order-1/order-items/existing-order-id', { deliveryDate: '2020-04-27', quantity: 3, price: 0.11 })
    .reply(400, {
      errors: [{
        field: 'DeliveryDate',
