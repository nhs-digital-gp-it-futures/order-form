...
const orderItemType = 'solution';

describe('solution order-item controller', () => {
  ...
  describe('getCatalogueOrderItem', () => {
    ...
    it('should call getData once with the correct params', async () => {
      ...
      expect(getData).toHaveBeenCalledWith({
        endpoint: `${orderApiUrl}/api/v1/orders/order-1/sections/solution/order-item-1`,
      ...
      describe('with no errors', () => {
        it('should post correctly formatted data', async () => {
          ...
          expect(postData).toHaveBeenCalledWith({
            endpoint: `${orderApiUrl}/api/v1/orders/order1/sections/solution`,
            body: {
              ...selectedPrice,
              serviceRecipient,
      ...
      describe('with no errors', () => {
        it('should post correctly formatted data', async () => {
          ...
          expect(putData).toHaveBeenCalledWith({
            endpoint: `${orderApiUrl}/api/v1/orders/order1/sections/solution/orderItemId-1`,
            body: {
              deliveryDate: '2020-12-25',
              quantity: 1,
              estimationPeriod: 'month',
