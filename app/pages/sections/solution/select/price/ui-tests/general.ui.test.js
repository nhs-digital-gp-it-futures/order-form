...
const pageUrl = 'http://localhost:1234/order/organisation/order-id/solution/select/solution/price';
...
test('should navigate to /organisation/order-id/solution/select/solution when click on backlink', async (t) => {
  await pageSetup(true);
  nock(orderApiUrl)
  ...
  await t
    ...
    .click(goBackLink)
    .expect(getLocation()).eql('http://localhost:1234/order/organisation/order-id/solution/select/solution');
});
...
test('should redirect to /organisation/order-id/solution/select/solution/price/recipient when a price is selected', async (t) => {
  await pageSetup(true);
  await t.navigateTo(pageUrl);
