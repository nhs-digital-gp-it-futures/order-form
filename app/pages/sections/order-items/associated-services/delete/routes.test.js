...
describe('Associated services delete routes', () => {
  ...
  describe('GET /organisation/:odsCode/:orderId/associated-services/delete/:catalogueItemId/confirmation/:solutionName', () => {
    const path = '/organisation/odsCode/some-order-id/associated-services/delete/order-item-1/confirmation/write-on-time-associated-service';
  ...
  describe('POST /organisation/:odsCode/:orderId/associated-services/delete/:catalogueItemId/confirmation/:solutionName', () => {
    const path = '/organisation/odsCode/some-order-id/associated-services/delete/order-item-1/confirmation/write-on-time-associated-service';
    ...
    it('should redirect to associated services deletion confirmation page, if the associated service is deleted', async () => {
      ...
      return request(setUpFakeApp())
        ...
        .then((res) => {
          ...
          expect(res.headers.location).toEqual(`${baseUrl}/organisation/odsCode/some-order-id/associated-services/delete/order-item-1/confirmation/write-on-time-associated-service/continue`);
        });
    });
  });

  describe('GET /organisation/:odsCode/:orderId/associated-services/delete/:catalogueItemId/confirmation/:solutionName/continue', () => {
    const path = '/organisation/odsCode/some-order-id/associated-services/delete/order-item-1/confirmation/write-on-time-associated-service/continue';
  ...
  describe('POST /organisation/:odsCode/:orderId/associated-services/delete/:catalogueItemId/confirmation/:solutionName/continue', () => {
    const path = '/organisation/odsCode/some-order-id/associated-services/delete/order-item-1/confirmation/write-on-time-associated-service/continue';
