...
const pageUrl = 'http://localhost:1234/order/organisation/order-id/solution/select/solution';
...
test('should navigate to /organisation/order-id/solution when click on backlink', async (t) => {
  await pageSetup();
  await t.navigateTo(pageUrl);
  ...
  await t
    ...
    .click(goBackLink)
    .expect(getLocation()).eql('http://localhost:1234/order/organisation/order-id/solution');
});
...
test('should redirect to /organisation/order-id/solution/select/solution/price when a solution is selected', async (t) => {
