...
describe('summary print page', () => {
  ...
  it('should render the recurring cost heading and description', componentTester(setup, (harness) => {
    ...
    harness.request(context, ($) => {
      ...
      const recurringCostDescription = $('p[data-test-id="recurring-cost-description"]');
  ...
  describe('Recurring cost totals', () => {
    const context = {
    ...
    it('should render the recurring cost table footer', componentTester(setup, (harness) => {
      harness.request(context, ($) => {
        const tFoot = $('div[data-test-id="recurring-cost-table"] tfoot');
