...
export const catalogueSolutionsSelectRoutes = (authProvider, addContext, sessionManager) => {
  router.get('/', authProvider.authorise({ claim: 'ordering' }), withCatch(logger, authProvider, async (req, res) => {
    ...
    return res.redirect(`${config.baseUrl}/organisation/${orderId}/solution/select/solution`);
  }));
  ...
  router.get('/solution', authProvider.authorise({ claim: 'ordering' }), withCatch(logger, authProvider, async (req, res) => {
    ...
    logger.info(`navigating to order ${orderId} solution select solution page`);
    return res.render('pages/sections/solution/select/solution/template.njk', addContext({ context, user: req.user, csrfToken: req.csrfToken() }));
  }));
  ...
  router.post('/solution', authProvider.authorise({ claim: 'ordering' }), withCatch(logger, authProvider, async (req, res) => {
    ...
    if (response.success) {
      ...
      return res.redirect(`${config.baseUrl}/organisation/${orderId}/solution/select/solution/price`);
    }
  ...
  router.get('/solution/price', authProvider.authorise({ claim: 'ordering' }), withCatch(logger, authProvider, async (req, res) => {
    ...
    logger.info(`navigating to order ${orderId} solution select price page`);
    return res.render('pages/sections/solution/select/price/template.njk', addContext({ context, user: req.user, csrfToken: req.csrfToken() }));
  }));
  ...
  router.post('/solution/price', authProvider.authorise({ claim: 'ordering' }), withCatch(logger, authProvider, async (req, res) => {
    ...
    if (response.success) {
      ...
      return res.redirect(`${config.baseUrl}/organisation/${orderId}/solution/select/solution/price/recipient`);
    }
  ...
  router.get('/solution/price/recipient', authProvider.authorise({ claim: 'ordering' }), withCatch(logger, authProvider, async (req, res) => {
    ...
    logger.info(`navigating to order ${orderId} solution select recipient page`);
    return res.render('pages/sections/solution/select/recipient/template.njk', addContext({ context, user: req.user, csrfToken: req.csrfToken() }));
  }));
  ...
  router.post('/solution/price/recipient', authProvider.authorise({ claim: 'ordering' }), withCatch(logger, authProvider, async (req, res) => {
    ...
    if (response.success) {
      ...
      return res.redirect(`${config.baseUrl}/organisation/${orderId}/solution/neworderitem`);
    }
