...
test('should render the oneOff cost item details in the table', async (t) => {
  ...
  await t
    ...
    .expect(await extractInnerText(oneOffCostRow0.find('td').nth(1))).eql('C000001-01-A10001-23')
    .expect(await extractInnerText(oneOffCostRow0.find('td').nth(2))).eql('Core Training')
    .expect(await extractInnerText(oneOffCostRow0.find('td').nth(3))).eql('585.00 per Day')
    .expect(await extractInnerText(oneOffCostRow0.find('td').nth(4))).eql('70')
    .expect(await extractInnerText(oneOffCostRow0.find('td').nth(5))).eql('40,850.00');
});
...
test('should render the recurring cost item details in the table', async (t) => {
  ...
  await t
    ...
    .expect(await extractInnerText(recurringCostRow0.find('td').nth(3))).eql('207.91 per practice per month')
    .expect(await extractInnerText(recurringCostRow0.find('td').nth(4))).eql('12 per year')
    .expect(await extractInnerText(recurringCostRow0.find('td').nth(5))).eql('25 September 2020')
    .expect(await extractInnerText(recurringCostRow0.find('td').nth(6))).eql('29,939.90')
    ...
    .expect(await extractInnerText(recurringCostRow2.find('td').nth(3))).eql('0.70 per fragment')
    .expect(await extractInnerText(recurringCostRow2.find('td').nth(4))).eql('600 per month')
    .expect(await extractInnerText(recurringCostRow2.find('td').nth(5))).eql('')
    .expect(await extractInnerText(recurringCostRow2.find('td').nth(6))).eql('5,040.00')
    ...
    .expect(await extractInnerText(recurringCostRow4.find('td').nth(3))).eql('207.91 per practice per month')
    ...
    .expect(await extractInnerText(recurringCostRow4.find('td').nth(6))).eql('29,939.90')
    ...
    .expect(await extractInnerText(recurringCostRow5.find('td').nth(3))).eql('106.02 per patient per month')
    .expect(await extractInnerText(recurringCostRow5.find('td').nth(4))).eql('12 per year')
    .expect(await extractInnerText(recurringCostRow5.find('td').nth(5))).eql('25 September 2020')
    .expect(await extractInnerText(recurringCostRow5.find('td').nth(6))).eql('15,267.60')
    ...
    .expect(await extractInnerText(recurringCostRow6.find('td').nth(3))).eql('1.26 per patient per year')
    .expect(await extractInnerText(recurringCostRow6.find('td').nth(4))).eql('3,415 per month')
    .expect(await extractInnerText(recurringCostRow6.find('td').nth(5))).eql('6 July 2020')
    .expect(await extractInnerText(recurringCostRow6.find('td').nth(6))).eql('4,302.90');
});
