...
describe('solution section routes', () => {
  describe('GET /organisation/:orderId/solution', () => {
    const path = '/organisation/some-order-id/solution';
    ...
    it('should return the solution page if authorised', () => {
      ...
      return request(setUpFakeApp())
        ...
        .expect(200)
        .then((res) => {
          expect(res.text.includes('data-test-id="solution-page"')).toBeTruthy();
          expect(res.text.includes('data-test-id="error-title"')).toBeFalsy();
        });
    });
  });

  describe('POST /organisation/:orderId/solution', () => {
    const path = '/organisation/order-id/solution';
    afterEach(() => {
  ...
  describe('GET /organisation/:orderId/solution/:orderItemId', () => {
    const path = '/organisation/some-order-id/solution/neworderitem';
    ...
    it('should return the solution order item page if authorised', () => {
  ...
  describe('POST /organisation/:orderId/solution/:orderItemId', () => {
    const path = '/organisation/some-order-id/solution/neworderitem';
    ...
    it('should show the solution order item page with errors if there are FE caught validation errors', async () => {
      orderItemRoutesHelper.getPageData = jest.fn().mockResolvedValue({});
      orderItemController.getOrderItemContext = jest.fn().mockResolvedValue({});
    ...
    it('should show the solution order item page with errors if the api response is unsuccessful', async () => {
      orderItemRoutesHelper.getPageData = jest.fn().mockResolvedValue({});
      orderItemController.getOrderItemContext = jest.fn().mockResolvedValue({});
    ...
    it('should redirect to /organisation/some-order-id/solution if there are no validation errors and post is successful', async () => {
      orderItemRoutesHelper.getPageData = jest.fn().mockResolvedValue({});
      orderItemController.getOrderItemContext = jest.fn().mockResolvedValue({});
      ...
      return request(setUpFakeApp())
        ...
        .then((res) => {
          expect(res.redirect).toEqual(true);
          expect(res.headers.location).toEqual(`${baseUrl}/organisation/some-order-id/solution`);
        });
    });
  });
});
