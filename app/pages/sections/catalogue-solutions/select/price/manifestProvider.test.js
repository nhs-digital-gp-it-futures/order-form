...
import { getPriceManifest } from './manifestProvider';
...
describe('getPriceManifest', () => {
  ...
  expect(getPriceManifest(provisioningType)).toEqual(expectedResult);
});
  ...
  JSON.parse = jest.fn();
  getPriceManifest(provisioningType);
