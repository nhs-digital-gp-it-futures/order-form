...
const setup = {
  template: {
    path: 'pages/sections/solution/select/solution/template.njk',
  },
};

describe('solution select page', () => {
  it('should render a backLink', componentTester(setup, (harness) => {
    const context = {
      orderId: 'order-1',
      backLinkText: 'Go back',
      backLinkHref: '/organisation/order-1/solution',
    };
    ...
    harness.request(context, ($) => {
      ...
      expect($(backLink).find('a').attr('href')).toEqual('/organisation/order-1/solution');
    });
  }));
