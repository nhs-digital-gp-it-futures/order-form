...
describe('associated-services select page', () => {
  it('should render a backLink', componentTester(setup, (harness) => {
    const context = {
      ...
      backLinkHref: '/organisation/order-1/associated-services',
    };
    ...
    harness.request(context, ($) => {
      ...
      expect($(backLink).find('a').attr('href')).toEqual('/organisation/order-1/associated-services');
    });
  }));
  ...
  it('should render the associated-services-select page description', componentTester(setup, (harness) => {
    ...
    harness.request(context, ($) => {
      const description = $('h2[data-test-id="associated-service-select-page-description"]');
