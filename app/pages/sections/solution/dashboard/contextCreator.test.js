...
describe('solution contextCreator', () => {
  describe('getContext', () => {
        ...
        addedOrderItemsTable: {
          ...
          items: [
            [
              {
                data: 'Solution One',
                href: '/order/organisation/order-1/solution/orderItem1',
            ...
            [
              {
                data: 'Solution One',
                href: '/order/organisation/order-1/solution/orderItem2',
    ...
    it('should return the addOrderItemButtonHref', () => {
      const context = getContext({ orderId: 'order-1' });
      expect(context.addOrderItemButtonHref).toEqual(`${baseUrl}/organisation/order-1/solution/select/solution`);
    });
