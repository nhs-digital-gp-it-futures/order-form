...
test('should render the description', async (t) => {
  ...
  const description = Selector('[data-test-id="order-confirmation-page-description"]');
...
test('should render the get order summary button link with href /order/organisation/organisation/order-id/summary?print=true', async (t) => {
  await pageSetup();
  await t.navigateTo(pageUrl);
