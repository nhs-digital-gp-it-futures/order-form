...
describe('catalogue-solutions delete routes', () => {
  ...
  describe('GET /organisation/:orderId/catalogue-solutions/delete/:orderItemId/confirmation/:solutionName', () => {
    const path = '/organisation/some-order-id/catalogue-solutions/delete/order-item-1/confirmation/write-on-time';
  ...
  describe('POST /organisation/:orderId/catalogue-solutions/delete/:orderItemId/confirmation/:solutionName', () => {
    const path = '/organisation/some-order-id/catalogue-solutions/delete/order-item-1/confirmation/write-on-time';
    ...
    it('should redirect to catalogue solution deletion confirmation page, if the catalogue is deleted', async () => {
      ...
      return request(setUpFakeApp())
        ...
        .then((res) => {
          ...
          expect(res.headers.location).toEqual(`${baseUrl}/organisation/some-order-id/catalogue-solutions/delete/order-item-1/confirmation/write-on-time/continue`);
        });
    });
  });
});
