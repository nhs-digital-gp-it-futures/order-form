...
const pageUrl = 'http://localhost:1234/order/organisation/order-id/solution/select/solution/price/recipient';
...
test('should navigate to /organisation/order-id/solution/select/solution/price when click on backlink', async (t) => {
  await pageSetup();
  await t.navigateTo(pageUrl);
  ...
  await t
    ...
    .click(goBackLink)
    .expect(getLocation()).eql('http://localhost:1234/order/organisation/order-id/solution/select/solution/price');
});
...
test('should redirect to /organisation/order-id/solution/neworderitem when a recipient is selected', async (t) => {
  ...
  await t
    ...
    .click(button)
    .expect(getLocation()).eql('http://localhost:1234/order/organisation/order-id/solution/neworderitem');
});
