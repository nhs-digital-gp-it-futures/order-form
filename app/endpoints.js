...
const endpoints = {
  ...
  ordapi: {
    ...
    getCatalogueOrderItem: options => `${orderApiUrl}/api/v1/orders/${options.orderId}/sections/solution/${options.orderItemId}`,
    postSolutionOrderItem: options => `${orderApiUrl}/api/v1/orders/${options.orderId}/sections/solution`,
    putCatalogueOrderItem: options => `${orderApiUrl}/api/v1/orders/${options.orderId}/sections/solution/${options.orderItemId}`,
    getCommencementDate: options => `${orderApiUrl}/api/v1/orders/${options.orderId}/sections/commencement-date`,
    getAddedCatalogueSolutions: options => `${orderApiUrl}/api/v1/orders/${options.orderId}/sections/solution`,
    ...
    putCatalogueSolutions: options => `${orderApiUrl}/api/v1/orders/${options.orderId}/sections/solution`,
